    ...
    public class RegisterModel : PageModel
    {
        ...
        public SelectList RoleSelectList = new SelectList(
            new List<SelectListItem>
            {
                ...
                new SelectListItem {Selected=false, Text= "Artist Manager", Value="Artist Manager"},
                new SelectListItem {Selected=false, Text= "Composer", Value="Composer"},
                new SelectListItem {Selected=false, Text= "Producer", Value="Producer"},
                //Add more
            }, "Value", "Text", 1);
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new DDACAssignmentUser { Name=Input.Name, UserName = Input.Email, Email = Input.Email, Role=Input.Role };
